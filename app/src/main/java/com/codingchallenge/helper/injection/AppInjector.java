...
package com.codingchallenge.helper.injection;
...
import com.codingchallenge.di.DaggerAppComponent;
...
public class AppInjector {
    ...
    @NonNull
    public static AppComponent init(@NonNull CodingChallegeApp application) {
